// Tutorial URL: http://craftyjs.com/demos/tutorial/tutorial.html
// (but ours is modified to use Canvas 4.4
window.onload = function() {
    ...
    Crafty.scene("main", function() {
        generateWorld();
        // BELOW HERE IS WHERE WE WILL BE ADDING MOST OF THE STUFF FROM NOW ON
